...
import {StyledButtonDiv} from '../UtilComponents/StyledButton'
    ...
    return(
        <div className="MyNavBar">
            ...
            {biggerThan769 && (
                <div className="MyNavBarMenu">
                    ...
                    <div className="MyNavBarEnd">
                        <StyledButtonDiv onClick={onClickSettings}>
                            Settings
                        </StyledButtonDiv>
            ...
            */}
            ...
            <HeaderSettingsModal
                isOpen={showSettingsDlg} 
                onDismiss={()=>setShowSettingsDlg(false)}
            />
