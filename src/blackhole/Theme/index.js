...
//    text10:darkMode ? '#94febf' : '#94febf',
    ...
    */
   /*
    bg100:darkMode ? '#1e1c37ff' : 'black',
    bg101:darkMode ? '#94abfe' : 'black',
    bg102:darkMode ? '#373553' : 'black',
    bg103:darkMode ? '#6c8cfc' : 'black',
    bg105:darkMode ? '#636ef3' : 'black',
    modalBackground:darkMode ? '#0b0b0baa' : 'black',
    */
   bg100:darkMode ? '#3e3e3e' : 'black',
   bg101:darkMode ? '#fafafa' : 'black',
   bg102:darkMode ? '#666666' : 'black',
   bg103:darkMode ? '#6c8cfc' : 'black',
   bg105:darkMode ? '#999999' : 'black',
   bgPane:darkMode ? '#0000001a' : 'black',
   modalBackground:darkMode ? '#0b0b0baa' : 'black',
    
//    outLine1:darkMode ? '#393939' : 'black',
    outLine1:darkMode ? '#80808099' : 'black',
